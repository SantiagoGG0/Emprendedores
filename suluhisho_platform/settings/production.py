"""
Production settings for suluhisho_platform.
"""
...
# Configure AWS S3 or Cloudflare R2 here when ready
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@suluhisho.com')
